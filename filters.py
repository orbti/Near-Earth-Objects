...
class DateFilter(AttributeFilter):
    ...
    def get(cls, approach):
        """
        Get datetime attribute from `CloseApproach`.
        
        Datetime attribute is returned as a date.
        """
...
class HazardousFilter(AttributeFilter):
    ...
    @classmethod
    def get(cls, approach):
        """Get hazardous attribute from `CloseApproach`."""
        return approach.neo.hazardous


class DiameterFilter(AttributeFilter):
    """Create a new `DiameterFilter`."""

    @classmethod
    def get(cls, approach):
        """Get diameter attribute from `CloseApproach`."""
        return approach.neo.diameter


class VelocityFilter(AttributeFilter):
    """Create a new `VelocityFilter`."""

    @classmethod
    def get(cls, approach):
        """Get velocity attribute from `CloseApproach`."""
        return approach.velocity


class DistanceFilter(AttributeFilter):
    """Create a new `DistanceFilter`."""

    @classmethod
    def get(cls, approach):
        """Get distance attribute from `CloseApproach`."""
